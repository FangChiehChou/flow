...
av_num_case = 2:1:11;
hv = 'IDM';
FLOW_Sim_Results_path ='/media/lorr/TOSHIBA EXT/lorr_sim_out/1HV';
...
%% Save 
save('RL_1HV_results.mat','AV_stabilize_time','AV_stabilize_speed','AV_max_gap','AV_total_fuel','AV_VMT')
