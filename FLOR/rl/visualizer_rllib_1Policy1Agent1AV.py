...
def visualizer_rllib(args):
    ...
    for i in range(args.num_rollouts):
        vel = []
        state = env.reset()  #reset until the end of the warm-up duration
        if multiagent:
...
if __name__ == '__main__':
    ...
    ##/home/lorr/ray_results/stabilizing_the_ring/PPO_WaveAttenuationPOEnv-v0_0_2019-12-11_16-03-22aoja2zj9 200
