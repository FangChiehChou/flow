...
def sugiyama_example1(render=True, x=0, cont='OV_FTL'):
    ...
    sim_params = SumoParams(sim_step=0.1, render=False, emission_path='/home/lorr/flow/FLOR/Sim_0210_IDM_baseline/IDM_baseline')
...
if __name__ == "__main__":
    ...
    for _ in range(10):
        NumAV = 0
        av = 'PI'
        exp1 = sugiyama_example1(x = NumAV, cont=av, render=False)
