...
from car_following_models import LinOpt_Controller_IDM,IDM_Hobbit
...
def sugiyama_example1(render=True, x=0, cont='OV_FTL'):
    ...
    sim_params = SumoParams(sim_step=0.1, render=False, emission_path='/home/lorr/flow/FLOR/Sim1118_IDM_AVRider_{}/{}IDM_{}{}'.format(cont,22-x,x,cont))
    ...
    if x == 0:
        vehicles.add(
            veh_id="IDM",
            acceleration_controller=(IDM_Hobbit, {"noise":0.1}),
            car_following_params=SumoCarFollowingParams(
            min_gap=0,
            width = 0.08,
            length = 0.16   #set vehicle length to the size of the mini robot
        ),
    ...
    ## set vehicle lengths in the environment
...
if __name__ == "__main__":
    ...
    # import the experimendt variable
    NumAV = 0
    TypeAV = 'AUG'
    # ray.init(num_cpus=1)
